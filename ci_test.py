...
ci_test_file = 'nestopia_libretro' #Only build one addon for CI testing
...
script_settings['buildbot_settings']['build_platform_addons'] = [False,
																False,
																False,
																True,
																False,
...
for ii,platforms in enumerate(build_data['kodi_platforms']):
	for jj,core_name in enumerate([x for x in build_data['libretro_bb_info_dict'][ii]['filename_clean'] if x==ci_test_file]):
